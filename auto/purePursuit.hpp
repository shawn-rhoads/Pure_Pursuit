...
class PurePursuit {
     ...
     */
    PurePursuit( const std::vector<IndexedDistancePosePath> &ipaths, const okapi::QLength &ilookaheadDistance, bool iSlowDown);
    ...
    bool run( double x, double y, double yaw, const std::string &iid, const std::shared_ptr<okapi::OdomChassisController> &controller, double ispeed  );
    /**
